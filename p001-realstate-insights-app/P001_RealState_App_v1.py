...
st.markdown('*Additional information about House Rocket and this report are by the end of the page.*')
st.write('')
...
def portfolio_density(data, geofile):
    ...
    exp_density = st.expander("Click here to expand and see the portfolio concentration map by location and expected profit.", expanded=True)
    with exp_density:
...
def profit_business_attributes(data):
    ...
    exp_att_bus = st.expander('Click here to expand and see estimated profit table according to business attributes', expanded=True)
    with exp_att_bus:
...
def profit_properties_attributes(data):
    ...
    exp_att_prop = st.expander('Click here to expand and see estimated profit table according to properties attributes', expanded=False)
    with exp_att_prop:
